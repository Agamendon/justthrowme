  ...
  return (
    <div className="flex flex-col items-center justify-center h-full p-8 text-white">
      ...
      <div className="max-w-2xl text-center space-y-4 mb-8">
        ...
        <ul className="text-left space-y-2 text-lg text-white">
          <li className="flex items-start">
            <span className="text-green-300 mr-2">▸</span> Step 1: Get ready for the experience
          </li>
          <li className="flex items-start">
            <span className="text-green-300 mr-2">▸</span> Step 2: Follow the on-screen prompts
          </li>
          <li className="flex items-start">
            <span className="text-green-300 mr-2">▸</span> Step 3: Have fun and stay safe
          </li>
        </ul>
      </div>
