        ...
        <div className="bg-black border border-white/30 p-6 rounded-lg text-left space-y-3">
          ...
          <ul className="space-y-2 ml-4 text-white">
            <li className="flex items-start">
              <span className="text-green-300 mr-2">⚠</span> This is for entertainment purposes only
            </li>
            <li className="flex items-start">
              <span className="text-green-300 mr-2">⚠</span> You participate at your own risk
            </li>
            <li className="flex items-start">
              <span className="text-green-300 mr-2">⚠</span> You are responsible for your own safety
            </li>
            <li className="flex items-start">
              <span className="text-green-300 mr-2">⚠</span> You agree to all terms and conditions
            </li>
          </ul>
        </div>
      </div>
